    ...
    try {
      ...
      const imported = excelPreview.data.map((row, index) => {
        ...
        excelPreview.headers.forEach(header => {
          // Don't include Unique ID from Excel - it will be auto-generated by backend
          if (header !== 'Unique ID') {
        ...
        // Reorder fields according to REQUIRED_COLUMNS order
        // Note: Unique ID will be added by backend automatically
        return reorderFieldsByRequiredColumns(record)
      })
      
      console.log(`📝 Prepared ${imported.length} records for import (Unique IDs will be auto-generated)`)
